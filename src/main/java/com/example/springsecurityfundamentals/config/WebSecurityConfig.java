...
//        After Spring Security 5 if we want to use NoOpPasswordEncoder we need to prefix the password with '{noop}' else it
//        will throw java.lang.IllegalArgumentException: There is no PasswordEncoder mapped for the id "null"
